...
function TopBar() {
  const { telegramId, name } = useTelegram();
  const user = useQuery(
  ...
  return (
    <header
      ...
      style={{ paddingTop: "var(--tg-content-safe-area-top, 0px)" }}
    >
...
function BottomTabs() {
  ...
  return (
    <nav
      ...
      style={{ paddingBottom: "var(--tg-safe-area-bottom, 0px)" }}
    >
...
function useTelegramBackButton() {
  ...
  }, [isSubPage, isTelegram, showBackButton, hideBackButton, navigate]);
}
